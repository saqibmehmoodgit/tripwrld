...
import com.airline.repository.CustomerBookingRepository;
...
public class CustomerBookingServiceImpl 
{
	...
	public boolean saveCustommerBooking(ResponseDto responseDto)
	{
		System.out.println( "  this is customerBookingServiceImpl  ");
		CustomerBooking custBooking =  responseMapper.responseDtoToCustomerBooking(responseDto);
		customerBookingRepository.save(custBooking);
		return true;
	}
